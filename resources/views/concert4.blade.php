                            ...
                            <div class="col-xl-3 col-lg-3">
                                <div class="logo">
                                    <a href="{{ route('concert1') }}">
                                        <h2 style="background: linear-gradient(90deg, #dc143c, #8b0000); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold; margin-bottom: 0;">ARCTIC MONKEYS</h2>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="{{ route('concert4') }}">home</a></li>
                                            <li><a href="#performer">Band</a></li>
                            ...
                            <div class="inner_wrap">
                                ...
                                <div class="porgram_top">
                                    <span class=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">09:15
                                        PM</span>
                                    <h4 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Arctic Monkeys Live</h4>
                                </div>
                                <div class="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="footer_widget">
                            <div class="address_details text-center">
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">May 25, 2027</h4>
                                <h3 class="wow fadeInUp text-warning" data-wow-duration="1s" data-wow-delay=".4s">Arctic Monkeys Live - Jakarta</h3>
                                <p class="wow fadeInUp text-light" data-wow-duration="1s" data-wow-delay=".5s">Do I Wanna Know? Yes, You Do.</p>
                                <a href="#" class="boxed-btn3 wow fadeInUp" data-wow-duration="1s"
                                    data-wow-delay=".6s">Get Your Ticket</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center wow fadeInDown" data-wow-duration="1s" data-wow-delay=".5s">
                            Copyright &copy;
                            <script>document.write(new Date().getFullYear());</script> Arctic Monkeys | The Car World Tour Jakarta. All rights reserved.
                        </p>
                    </div>
                </div>
            </div>

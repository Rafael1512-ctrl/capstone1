                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="footer_widget">
                            <div class="address_details text-center">
                                <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">15 Nov, 2026</h4>
                                <h3 class="wow fadeInUp text-info" data-wow-duration="1s" data-wow-delay=".4s">GBK,
                                    Jakarta</h3>
                                <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">Believe in Love.</p>
                                <a href="#" class="boxed-btn3 wow fadeInUp" data-wow-duration="1s"
                                    data-wow-delay=".6s">Join the Galaxy</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center wow fadeInDown" data-wow-duration="1s" data-wow-delay=".5s">
                            Copyright &copy;
                            <script>document.write(new Date().getFullYear());</script> Coldplay Official Tours. All
                            rights reserved.
                        </p>
                    </div>
                </div>

...
<head>
    ...
    <title>Bruno Mars | 24K Magic World Tour Jakarta</title>
    <meta name="description" content="Bruno Mars 24K Magic World Tour Live in Jakarta - Complete info, setlist, merchandise, venue, and fan experience.">
    ...
    <style>
        .slider_bg_1 {
            background-image: url("https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&q=80&w=2070");
...
<body>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-12">
                        <div class="slider_text text-center">
                            ...
                            <span class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">November 10, 2027</span>
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">24K Magic World Tour Jakarta</h3>
                            <p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s">Jakarta International Stadium</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="single_performer wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                <div data-tilt class="thumb">
                                     <img src="https://images.unsplash.com/photo-1502444330042-d1a1ddf9bb5b?auto=format&fit=crop&q=80&w=600" alt="Bruno Mars" class="img-fluid" style="border-radius: 10px;">
                                </div>
                                <div class="performer_heading">
                                    <h4 class="text-light">Bruno Mars</h4>
                                    <span style="color: #d4af37; font-weight: 300; letter-spacing: 1px;">Global Pop Superstar</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section_title text-center mb-80">
                        <h3 class="wow fadeInRight text-light" data-wow-duration="1s" data-wow-delay=".3s">24K Magic Experience</h3>
                        <p class="wow fadeInRight" style="color: #b5a265;" data-wow-duration="1s" data-wow-delay=".4s">Bruno Mars is bringing the funk to Jakarta! Get ready for an electrifying night full of dancing, endless hits, and pure 24K magic. An unforgettable celebration of music and groove.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="about_thumb">
                        ...
                        <div class="thumb_inner  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <img src="https://images.unsplash.com/photo-1506157786151-b8491531f063?auto=format&fit=crop&q=80&w=1000"
                                alt="Bruno Mars 24K Magic World Tour">
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6">
                    <div class="about_info pl-68">
                        <h4 class=" wow fadeInLeft text-light" data-wow-duration="1s" data-wow-delay=".5s">Unstoppable Groove</h4>
                        <p class=" wow fadeInLeft text-light" data-wow-duration="1s" data-wow-delay=".6s">Experience live performances of smash hits like "Uptown Funk", "That's What I Like", and "Treasure". Join thousands of fans in an explosive stadium show that redefines live entertainment.</p>
                            ...
                            <div class="inner_wrap">
                                ...
                                <div class="porgram_top">
                                    <span class=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">09:15
                                        PM</span>
                                    <h4 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Bruno Mars Live</h4>
                                </div>
                                <div class="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="https://images.unsplash.com/photo-1533174000276-2615560965d1?auto=format&fit=crop&q=80&w=400"
                                        alt="">
                                </div>
    ...
    <div id="venue" class="map_area">
        ...
        <div class="location_information black_bg wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
            <h3 class="text-info" style="color: #d4af37 !important;">Jakarta International Stadium</h3>
            <div class="info_wrap">
                <div class="single_info">
                    <span>Venue:</span>
                    <p>Papanggo, Tanjung Priok<br>North Jakarta, 14340</p>
                </div>
                <div class="single_info">
                    <span>Phone:</span>
                    <p>+62 (21) 123 4567</p>
    ...
    @include('layouts.headerconcert.footer', [
        'footerDate' => 'November 10, 2027',
        'footerLocation' => 'Bruno Mars Live - Jakarta',

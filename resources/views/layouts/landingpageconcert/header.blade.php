<header role="banner">
    <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand " href="{{ route('home') }}">LuxTix</a>
                    ...
                    @guest
                        <li class="nav-item mr-2">
                            <a class="nav-link btn btn-outline-primary px-3 py-1" href="{{ route('login') }}"
                                style="border-radius: 20px; border-color: #9d50bb; color: #9d50bb;">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn btn-primary px-3 py-1 text-white" href="{{ route('register') }}"
                                style="border-radius: 20px; background: linear-gradient(to right, #9d50bb, #6e48aa); border: none;">Register</a>
                        </li>
                    @else
                        <li class="nav-item dropdown">

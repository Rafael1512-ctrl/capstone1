...
<head>
    ...
    <title>The Weeknd | After Hours Til Dawn Tour Jakarta</title>
    <meta name="description" content="The Weeknd After Hours Til Dawn Tour Live in Jakarta - Complete info, setlist, merchandise, venue, and fan experience.">
    ...
    <style>
        .slider_bg_1 {
            background-image: url("https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80&w=2070");
...
<body>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-12">
                        <div class="slider_text text-center">
                            ...
                            <span class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">December 15, 2027</span>
                            <h3 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">After Hours Til Dawn Tour Jakarta</h3>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="single_performer wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                                ...
                                <div class="performer_heading">
                                    ...
                                    <span style="color: #ff3333; font-weight: 300; letter-spacing: 1px;">Global R&B/Pop Icon</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section_title text-center mb-80">
                        <h3 class="wow fadeInRight text-light" data-wow-duration="1s" data-wow-delay=".3s">After Hours Experience</h3>
                        <p class="wow fadeInRight" style="color: #d1b8b8;" data-wow-duration="1s" data-wow-delay=".4s">The Weeknd brings his record-breaking After Hours Til Dawn Tour to Jakarta. Enter the cinematic, neon-drenched universe characterized by dark synthesizers, hypnotic beats, and hauntingly beautiful vocals.</p>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-6">
                    <div class="about_thumb">
                        ...
                        <div class="thumb_inner  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                            <img src="https://images.unsplash.com/photo-1570881656044-fbfdcd63675a?auto=format&fit=crop&q=80&w=1000"
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="about_info pl-68">
                        <h4 class=" wow fadeInLeft text-light" data-wow-duration="1s" data-wow-delay=".5s">Cinematic Spectacle</h4>
                        <p class=" wow fadeInLeft text-light" data-wow-duration="1s" data-wow-delay=".6s">Experience live performances of incredible smash hits like "Blinding Lights", "Starboy", and "Save Your Tears". Join thousands of fans in an explosive stadium show that redefines the modern pop concert experience.</p>
                            ...
                            <div class="inner_wrap">
                                ...
                                <div class="porgram_top">
                                    <span class=" wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".3s">09:15
                                        PM</span>
                                    <h4 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">The Weeknd Live</h4>
                                </div>
                                <div class="thumb  wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">
                                    <img src="https://images.unsplash.com/photo-1549405615-5a21ff461245?auto=format&fit=crop&q=80&w=400"
                                        alt="">
                                </div>
    ...
    <div id="venue" class="map_area">
        ...
        <div class="location_information black_bg wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
            <h3 class="text-info" style="color: #ff3333 !important;">Indonesia Arena</h3>
            <div class="info_wrap">
    ...
    @include('layouts.headerconcert.footer', [
        'footerDate' => 'December 15, 2027',
        'footerLocation' => 'The Weeknd Live - Jakarta',

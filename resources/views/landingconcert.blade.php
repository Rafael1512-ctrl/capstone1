  ...
  <header role="banner">
    <nav class="navbar navbar-expand-lg  bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand " href="{{ route('landingconcert') }}">CardBoard</a>
      ...
      <div class="row mb-5 no-gutters">
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="100">
          <a href="portfolio-single.html" class="work-thumb">
            ...
            <img src="{{ asset('cardboard-assets/img/work_1.jpg') }}" alt="Image" class="img-fluid">
          </a>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="200">
          <a href="portfolio-single.html" class="work-thumb">
            ...
            <img src="{{ asset('cardboard-assets/img/work_2.jpg') }}" alt="Image" class="img-fluid">
          </a>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="300">
          <a href="portfolio-single.html" class="work-thumb">
            ...
            <img src="{{ asset('cardboard-assets/img/work_3.jpg') }}" alt="Image" class="img-fluid">
          </a>
        </div>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6" data-aos="fade" data-aos-delay="400">
          <a href="portfolio-single.html" class="work-thumb">
            ...
            <img src="{{ asset('cardboard-assets/img/work_4.jpg') }}" alt="Image" class="img-fluid">
          </a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 order-1">
          <figure class="img-dotted-bg">
            <img src="{{ asset('cardboard-assets/img/about_1.jpg') }}" alt="Image" class="img-fluid">

            <img src="{{ asset('cardboard-assets/img/work_1.jpg') }}" alt="Image" class="img-fluid img-absolute" data-aos="fade-left">
    ...
    <div class="container">
      ...
      <div class="nonloop-block-11 owl-carousel">
        <div class="item">
          <div class="block-33 h-100">
            <div class="vcard d-flex mb-3">
              <div class="image align-self-center"><img src="{{ asset('cardboard-assets/img/person_1.jpg') }}" alt="Person here"></div>
        ...
        <div class="item">
          <div class="block-33 h-100">
            <div class="vcard d-flex mb-3">
              <div class="image align-self-center"><img src="{{ asset('cardboard-assets/img/person_2.jpg') }}" alt="Person here"></div>
              <div class="name-text align-self-center">

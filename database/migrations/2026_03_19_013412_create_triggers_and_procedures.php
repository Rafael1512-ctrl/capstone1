...
class CreateTriggersAndProcedures extends Migration
{
    public function up()
    {
        ...
        // Buat trigger before_insert_orders
        DB::unprepared('
    ...
    ');
        ...
        // Buat trigger after_insert_payments
        DB::unprepared('
    ...
    ');
        ...
        // Buat trigger after_update_payments
        DB::unprepared('
    ...
    ');
        ...
        // Buat trigger before_insert_ticket_reservations
        DB::unprepared('
    ...
    ');
        ...
        // Buat stored procedure sp_organizer_dashboard
        DB::unprepared('
